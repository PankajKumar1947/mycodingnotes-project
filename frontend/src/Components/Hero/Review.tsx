        ...
        <div className="sm:max-w-[93%] sm:mx-auto mt-6 sm:mt-12 flex justify-between flex-wrap rounded-lg">
            ...
            <div className="border border-indigo-500 m-4 sm:mt-8 mb-8 max-w-lg  rounded-lg lg:mt-0">
                ...
                <div className="p-4 sm:p-8 space-y-4 sm:space-y-8">
                    <input id="name" type="text" className=" w-full rounded-lg border  px-2 py-2 border-blue-300 bg-transparent " placeholder="Enter your name" />

                    <input id="email" type="email" className=" w-full  rounded-lg border  px-2 py-2 border-blue-300 bg-transparent " placeholder="Enter your email" />

                    <div>
                        <label className=" inline-block max-w-full text-gray-300 font-semibold">Your Review</label>
                        <textarea id="about" rows={4} className="w-full rounded-lg border  px-2 py-2 border-blue-300 bg-transparent " placeholder="Share your experience with MyCodingNotes..."></textarea>
                    </div>
