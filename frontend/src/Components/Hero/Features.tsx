...
const Features = () => {
    return (
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-4 px-4 py-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
            <div>
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-blue-600">Why Choose <span className='bg-gradient-to-l from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text py-1'> MyCodingNotes ?</span> </h2>
                <p className="mt-4 ">
