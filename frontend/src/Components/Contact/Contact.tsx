...
const Contact = () => {
    ...
    return (
        <div className="isolate  px-6 py-24 sm:py-32 lg:px-8 relative text-white">
            <div className="inset-x-0  z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]" aria-hidden="true">
                <div className="relative left-1/2 -z-10 aspect-[1155/678] h-[100vh] sm:h-[80vh] w-full -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
                    ...
                    <div className="grid grid-cols-1 gap-x-8 gap-y-2 sm:gap-y-6 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="relative mt-2.5">
                                ...
                                <input type="tel" name="phone-number" id="phone-number" autoComplete="tel"
                                    className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 bg-transparent focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                        <div className="sm:col-span-2">
                        ...
                        <div className="flex gap-x-4 sm:col-span-2">
                            <div className="flex h-6 items-center">
                                <button type="button"
                                    className={`flex w-8 flex-none cursor-pointer rounded-full p-px transition-colors duration-200 ease-in-out ${agreed ? 'bg-indigo-600' : 'bg-gray-600'}`}
                                    role="switch" aria-checked={agreed} onClick={handleSwitchToggle} aria-labelledby="switch-1-label">
                                    <span className="sr-only">Agree to policies</span>
                                    <span aria-hidden="true"
                                        className={`h-4 w-4 transform rounded-full bg-white shadow-sm transition duration-200 ease-in-out ${agreed ? 'translate-x-4' : 'translate-x-0'}`}></span>
                                </button>
                            </div>
                            <label className="text-sm leading-6 text-gray-400" id="switch-1-label">
                                By selecting this, you agree to our
                                <a href="#" className="font-semibold text-indigo-400"> privacy&nbsp;policy</a>.
                            </label>
                        </div>
                    </div>
                    <div className="mt-10">
